...
root = tk.Tk()
root.title("Recoil")
root.geometry("420x200")  # Set the window size
...
custom_speed_entry.grid(row=1, column=1, padx=5, pady=10, ipadx=9, sticky=tk.W)
...
sleep_duration_entry.grid(row=2, column=1, padx=5, pady=10, ipadx=9, sticky=tk.W)
...
toggle_caps_lock_check.grid(row=2, column=2, padx=5, pady=10, sticky=tk.W)
...
macros_enabled_check.grid(row=3, column=2, padx=5, pady=10, sticky=tk.W)
...
toggle_button.grid(row=3, column=1, columnspan=4, padx=5, pady=10, ipadx=34, sticky=tk.W)

credits_label = ttk.Label(frame, text="Made by TX24 (v1.2)")
credits_label.grid(row=3, column=0, padx=5, pady=10, sticky=tk.W)
