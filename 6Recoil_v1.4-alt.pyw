...
def open_config_window():
    ...
    ttk.Label(config_window, text="Sleep Duration:").grid(row=7, column=0, padx=10, pady=5, sticky=tk.W)
    sleep_duration_entry = ttk.Entry(config_window)
    sleep_duration_entry.insert(0, str(sleep_duration))
    sleep_duration_entry.grid(row=7, column=1, padx=5, pady=5, sticky=tk.W)
