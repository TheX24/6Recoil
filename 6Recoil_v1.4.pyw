...
def open_config_window():
    def save_and_close():
        global custom_messages, dark_mode_enabled, rf_duration, rf_interval
    ...
    ttk.Label(config_window, text="Keypress Duration:").grid(row=7, column=0, padx=5, pady=5)
    ...
    ttk.Label(config_window, text="Interval Between Keypresses:").grid(row=7, column=1, padx=5, pady=5)
